...
namespace Trading {
    MarketMaker::MarketMaker(Common::Logger *logger, Trading::TradeEngine *trade_engine,
                             const Trading::FeatureEngine *feature_engine, Trading::OrderManager *order_manager,
